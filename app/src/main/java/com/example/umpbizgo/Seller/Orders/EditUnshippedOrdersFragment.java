 ...
 */
public class EditUnshippedOrdersFragment extends Fragment {
    View view;
    ...
    public EditUnshippedOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_edit_unshipped_order_seller, container, false);
        orderReference = FirebaseDatabase.getInstance().getReference().child("Orders");
        productname = view.findViewById(R.id.od_unshipped_shipping_product_name);
        productimage = view.findViewById(R.id.od_unshipped_shipping_product_image);
        productquantity = view.findViewById(R.id.od_unshipped_shipping_product_quantity);
        producttotalprice = view.findViewById(R.id.od_unshipped_shipping_product_price);
        Orderstatus = view.findViewById(R.id.od_unshipped_shipping_order_status);
        updateOrderButton = view.findViewById(R.id.od_unshipped_shipping_update_product_button);
        orderidtoolbar = view.findViewById(R.id.od_unshipped_order_id_toolbar);
        postalinformation = view.findViewById(R.id.od_unshipped_shipping_order_postal);
        addpostal= view.findViewById(R.id.unshipped_postalinfoswitch);
        ...
        postalinformation.setVisibility(View.INVISIBLE);

        addpostal.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if(isChecked) {
                    postalinformation.setVisibility(View.VISIBLE);
                }
                else {
                    postalinformation.setVisibility(View.INVISIBLE);
                }
