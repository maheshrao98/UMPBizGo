 ...
 */
public class SellerCancelledOrdersFragment extends Fragment {
    View view;
    ...
    public SellerCancelledOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_seller_cancelled_orders, container, false);
