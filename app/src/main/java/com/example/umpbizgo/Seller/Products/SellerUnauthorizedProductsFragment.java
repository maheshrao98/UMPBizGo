...
import com.example.umpbizgo.Seller.Products.EditUnauthorizedProductFragment;
 ...
 */
public class SellerUnauthorizedProductsFragment extends Fragment {
    View view;
    private DatabaseReference ProductReference;
    private RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;

    public SellerUnauthorizedProductsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_seller_unauthorized_products, container, false);
        ProductReference = FirebaseDatabase.getInstance().getReference().child("Unauthorized Products");
        recyclerView = view.findViewById(R.id.recycler_seller_menu_2);
                                ...
                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        if (i == 0) {
                                            ...
                                            EditUnauthorizedProductFragment fragunauthproducts = new EditUnauthorizedProductFragment();
                                            Bundle bundle = new Bundle();
                                            bundle.putString("pid", model.getPid());
                                            fragunauthproducts.setArguments(bundle);
                                            ft3.replace(R.id.frame_seller_unauthorized_product, fragunauthproducts);
                                            ft3.commit();
                                        }
                                        if (i == 1) {
