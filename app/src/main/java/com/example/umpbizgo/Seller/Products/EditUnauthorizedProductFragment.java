 ...
 */
public class EditUnauthorizedProductFragment extends Fragment {
    View view;
    ...
    public EditUnauthorizedProductFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_edit_unauth_product, container, false);
        ...
        ProductReference = FirebaseDatabase.getInstance().getReference().child("Unauthorized Products").child(productID);
        editproductbutton = view.findViewById(R.id.edit_unauthorized_product);
        gotoproductpage = view.findViewById(R.id.backfromeditunauthorizedproductpage);
        editproductdescription = view.findViewById(R.id.edit_unauthorized_product_description);
        editproductimage = view.findViewById(R.id.change_unauthorized_product_image);
        editproductprice = view.findViewById(R.id.edit_unauthorized_product_price);
        edittoolbarnamedisplay = view.findViewById(R.id.editunauthproductnamedisplay);
        editproductname = view.findViewById(R.id.edit_unauthorized_product_name);
        editproductcategory = view.findViewById(R.id.edit_unauthorized_product_category);
    ...
    private void GoToProductPage() {
        ...
        SellerUnauthorizedProductsFragment frageditproductsdetails = new SellerUnauthorizedProductsFragment();
        ft3.replace(R.id.frame_edit_unauth_product, frageditproductsdetails);
        ft3.commit();
    }
