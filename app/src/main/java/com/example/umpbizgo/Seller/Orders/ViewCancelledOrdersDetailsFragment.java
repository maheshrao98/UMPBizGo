...
public class ViewCancelledOrdersDetailsFragment extends Fragment {
    View view;
    TextView productname, producttotalprice, productquantity, orderidtoolbar;
    ...
    public ViewCancelledOrdersDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        productname = view.findViewById(R.id.od_cancelled_shipping_product_name);
        productimage = view.findViewById(R.id.od_cancelled_shipping_product_image);
        productquantity = view.findViewById(R.id.od_cancelled_shipping_product_image);
        producttotalprice = view.findViewById(R.id.od_cancelled_shipping_product_price);
        Orderstatus = view.findViewById(R.id.od_cancelled_shipping_order_status);
        updateOrderButton = view.findViewById(R.id.od_cancelled_shipping_update_product_button);
        orderidtoolbar = view.findViewById(R.id.od_cancelled_order_id_toolbar);
        backtoorder = view.findViewById(R.id.backtoviewsellerorderButton);
