...
public class EditWaitingApprovalProductsFragment extends Fragment {
    View view;
    ...
    public EditWaitingApprovalProductsFragment() {
    ...
    private void SaveUserInformationToDatabase() {
        ...
        FragmentTransaction ft3 = getFragmentManager().beginTransaction();
        EditWaitingApprovalProductsFragment frageditproductsdetails = new EditWaitingApprovalProductsFragment();
        ft3.replace(R.id.frame_edit_auth_product, frageditproductsdetails);
        ft3.commit();
    }
