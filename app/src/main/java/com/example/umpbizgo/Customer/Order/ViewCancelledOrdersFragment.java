 ...
 */
public class ViewCancelledOrdersFragment extends Fragment {
    ...
    public ViewCancelledOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_view_cancelled_orders, container, false);

        firebaseAuth = FirebaseAuth.getInstance();
        userID = firebaseAuth.getCurrentUser().getUid();
        orderReference = FirebaseDatabase.getInstance().getReference().child("Cancelled Orders");

        recyclerView = view.findViewById(R.id.recycler_customer_cancelled_order);
