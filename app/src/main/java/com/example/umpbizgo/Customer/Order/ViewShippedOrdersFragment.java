...
import com.example.umpbizgo.Seller.Orders.ViewShippedOrderDetailsFragment;
 ...
 */
public class ViewShippedOrdersFragment extends Fragment {
    ...
    public ViewShippedOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_view_shipped_orders, container, false);
        firebaseAuth = FirebaseAuth.getInstance();
        userID = firebaseAuth.getCurrentUser().getUid();
        orderReference = FirebaseDatabase.getInstance().getReference().child("Shipped Orders");

        recyclerView = view.findViewById(R.id.recycler_customer_shipped_order);
                    ...
                    protected void onBindViewHolder(@NonNull OrderViewHolder holder, int position, @NonNull Orders model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                ViewShippedCustomerOrderDetailsFragment fragcustorderview = new ViewShippedCustomerOrderDetailsFragment();
