 ...
 */
public class ViewUnshippedOrdersFragment extends Fragment {
    ...
    public ViewUnshippedOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_view_unshipped_orders, container, false);
                    ...
                    protected void onBindViewHolder(@NonNull OrderViewHolder holder, int position, @NonNull Orders model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                ViewUnshippedOrderDetailsFragment fragcustorderview = new ViewUnshippedOrderDetailsFragment();
                                Bundle bundle =new Bundle();
                                bundle.putString("orderID",model.getOid());
                                fragcustorderview.setArguments(bundle);
                                ft.replace(R.id.frame_view_unshipped_order, fragcustorderview);
                                ft.commit();
                            }
                        });
                    }
